...
namespace VMAP
{
    ...
    */
    ...
    public:
        ...
        int getChildval(int pNo) { return iChilds[pNo]; }
        void setChildval(int pNo, int val) { iChilds[pNo]=val; }
        // pChildNo = 0 or 1
        ...
        inline void setStartPosition(unsigned int sp) { iStartPosition = sp; }
